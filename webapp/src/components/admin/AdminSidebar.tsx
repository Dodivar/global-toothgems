 ...
 *
 * Two groups, and the second one is the point: Orders, Customers, Training,
 * Analytics and Settings are drawn and permanently disabled, so the prototype
...
const SOON: { labelKey: string; icon: LucideIcon }[] = [
  { labelKey: "admin.nav.orders", icon: ShoppingBag },
